...
try
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "MeetupService");
    ...
    {
        var context = scope.ServiceProvider.GetRequiredService<MeetupServiceDbContext>();
        ...
        {
            context.Database.ExecuteSql($"DROP TABLE Groups");

            context.Database.ExecuteSql($"DROP SCHEMA Meetup");
